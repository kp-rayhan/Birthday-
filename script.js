...
function showProposal() {
  ...
  document.getElementById('noBtn').addEventListener('click', () => {
    ...
    proposal.classList.add('hidden');
    response.innerHTML = "<h2>💔 It's okay... just remember: the strongest hearts still care in silence. It’s me, Rayhan, a whisper in the wind you’ll never quite forget.Though our stars may not align this time,I’ll carry your light gently in my heart,A silent melody that never fades...</h2>";
    response.classList.remove('hidden');
  }, { once: true });
}
